...
export default function HomePage() {
  ...
  const kiweSPLAddress = "CbazZEWMxFoXthk8s347PqvDG4JkvnNiCC3zZkah4aqD";
      ...
      <div className="container-home">
        ...
        <div className="section teaser community">
          <div className="inner">
            ...
            <p>
              We are the most important part of Kiwe. Open source is our best way to provide transparency and a community driven organisation increase the amount of people who can understand and improve the project. 
            </p>
